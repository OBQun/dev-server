import { JsonController, Post, BodyParam, Put, CurrentUser, UploadedFile, ContentType, Body } from "routing-controllers";
...
export class AdminController {
    ...
    async uploadAvatar(@CurrentUser({ required: true }) admin: Admin,
        ...
        return { path: await this.service.saveAvatar(admin, file.path.substring(file.path.indexOf('/'))) }
        // TODO 是否删除原头像文件
    }
